...
function ResponsiveLayout() {
    return (
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-10 gap-4 mt-4">
                ...
                <div class="bg-blue-500 p-4">Box 10</div>
                <div class="bg-blue-500 p-4">Box 11</div>
                <div class="bg-blue-500 p-4">Box 12</div>
            </div>
