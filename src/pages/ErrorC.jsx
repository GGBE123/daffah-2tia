export default function ErrorC() {
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-white text-center px-4">
            <h1 className="text-[100px] font-bold text-black leading-none">403</h1>
            <h2 className="text-2xl font-medium text-black mt-2">Forbidden</h2>
            <p className="text-base text-black mt-2">You don't have permission to access this resource</p>
            <button
